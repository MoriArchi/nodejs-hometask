...
export default function SignIn({ setIsLoggedIn }) {
    ...
    return (
        <form className={classes.root} noValidate autoComplete="off">
            <TextField onChange={onEmailChange} id="email" label="Required" placeholder="Email"/>
            <TextField onChange={onPasswordChange} id="password" label="Required" placeholder="Password"
                       type="password"/>
